...
function send(f,active){f.contentWindow?.postMessage({type:'iso-lab-visibility',active,theme:document.documentElement.dataset.theme||'dark'},location.origin);}
