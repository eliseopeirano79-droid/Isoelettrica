...
test('Anatomia adulta e fetale: geometria, controlli e attribuzioni disponibili offline',async()=>{const w=worker();await w.dispatch('install');const c=await w.caches.open(cacheName);for(const f of ['prototipo-cuore/index.html','prototipo-cuore/fetale.html','prototipo-cuore/heart-z-anatomy.glb','prototipo-cuore/atlas-coronary-map.json','prototipo-cuore/coronary-paths.json','prototipo-cuore/viewer.js','prototipo-cuore/lab.js','prototipo-cuore/fetal.js','prototipo-cuore/fetal-core.js','prototipo-cuore/ATTRIBUZIONI.md','atlas-geometry.js?v='+version,'cardiac-clock.js?v='+version,'lab-embed.js?v='+version,'cardiac-mechanics.js?v='+version,'cardiac-attachments.js?v='+version,'conduction-model.js?v='+version,'conduction-view.js?v='+version,'pathology-catalog.js?v='+version,'prototipo-cuore/pathology-ui.js'])assert.ok(await c.match(base+f),f);});
