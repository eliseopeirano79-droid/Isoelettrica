> Copia identica di `AGENTS.md`. Se il tuo ambiente non legge automaticamente `AGENTS.md` dalla radice del repository, incolla questo testo all'inizio di ogni sessione, prima del prompt del giorno.
