...
const CORE = ['./', './index.html', './anatomia.html', './icon-192.png', './icon-512.png', './apple-touch-icon.png', './manifest.webmanifest' + Q]
  .concat(['app.js', 'engine.js', 'quiz.js', 'ipertrofie.js', 'data.js', 'atlante-digitale.js', 'ptbxl.js', 'three.min.js', 'cuore3d.js', 'coronarie.js', 'gltfloader.js', 'atlas-geometry.js', 'heart-atlas.js', 'cardiac-clock.js', 'anatomy-host.js', 'lab-embed.js', 'atlas-theme.css','cardiac-attachments.js','cardiac-mechanics.js','conduction-model.js','conduction-view.js','pathology-catalog.js'].map(f => './' + f + Q))
