...
const CORE = ['./', './index.html', './anatomia.html', './icon-192.png', './icon-512.png', './apple-touch-icon.png', './manifest.webmanifest' + Q]
  .concat(['app.js', 'engine.js', 'quiz.js', 'ipertrofie.js', 'data.js', 'atlante-digitale.js', 'ptbxl.js', 'three.min.js', 'cuore3d.js', 'coronarie.js', 'gltfloader.js', 'atlas-geometry.js', 'heart-atlas.js', 'cardiac-clock.js', 'anatomy-host.js', 'lab-embed.js', 'atlas-theme.css'].map(f => './' + f + Q))
  .concat(['three.min.js','gltfloader.js','engine.js','data.js'].map(f=>'./'+f))
  .concat(['index.html','fetale.html','style.css','viewer.js','lab-core.js','lab.js','motion.js','fetal-core.js','fetal.js','heart-z-anatomy.glb','atlas-coronary-map.json','coronary-paths.json','ATTRIBUZIONI.md','SOURCE-LICENSE.txt'].map(f=>'./prototipo-cuore/'+f));
