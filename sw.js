...
const CORE = ['./', './index.html', './anatomia.html', './icon-192.png', './icon-512.png', './apple-touch-icon.png', './manifest.webmanifest' + Q]
  .concat(['app.js', 'engine.js', 'quiz.js', 'ipertrofie.js', 'data.js', 'atlante-digitale.js', 'ptbxl.js', 'three.min.js', 'cuore3d.js', 'coronarie.js', 'gltfloader.js', 'atlas-geometry.js', 'heart-atlas.js', 'cardiac-clock.js', 'anatomy-host.js', 'lab-embed.js', 'atlas-theme.css','ui-surface.css','ui-surface.js','lab-ui.js','congenital-morphology.js','physiology-atlas.js','pulmonary-arteries.js', 'vascular-cuffs.js', 'anatomy-refinements.js','cardiac-attachments.js','cardiac-mechanics.js','conduction-model.js','conduction-view.js','pathology-catalog.js'].map(f => './' + f + Q))
  .concat(['three.min.js','gltfloader.js','engine.js','data.js'].map(f=>'./'+f))
  .concat(['index.html','fetale.html','style.css','viewer.js','pathology-ui.js','lab-core.js','lab.js','motion.js','fetal-core.js','fetal.js','heart-z-anatomy.glb','atlas-coronary-map.json','coronary-paths.json','ATTRIBUZIONI.md','SOURCE-LICENSE.txt'].map(f=>'./prototipo-cuore/'+f));
